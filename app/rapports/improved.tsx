...
const RapportsScreen = () => {
  ...
  const loadReportsData = async () => {
    try {
      ...
      const monthlyResult = await db.getAllAsync(monthlyQuery, [startDate.toISOString()]);
      ...
      const productsResult = await db.getAllAsync(productsQuery, [startDate.toISOString()]);
      ...
      const totalResult = await db.getFirstAsync(totalQuery, [startDate.toISOString()]);
