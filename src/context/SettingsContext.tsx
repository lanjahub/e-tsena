...
const TRANSLATIONS = {
  fr: {
    ...
    'list_title_placeholder': 'Titre de liste',
    'reports': 'Rapports',
    ...
    'list_renamed': 'Liste renommée avec succès',
    'rename_error': 'Impossible de renommer la liste',
    'success': 'Succès',
    'tips_title': 'Astuces E-tsena',
    'tip_1': 'Utilisez le bouton + pour ajouter une liste.',
    'tip_2': 'Une liste vide ne sera pas enregistrée.',
    'tip_3': 'Appuyez sur ... pour les options (renommer, supprimer).',
    ...
    'add_product_placeholder': 'Libellé produit (nom produit)...',
    'ok': 'OK',
    ...
    'see_global_stats': 'Voir les Graphiques Globaux',
    ...
    'period_details': 'Détails Période',
    ...
    'no_product_bought_period': 'Aucun produit acheté durant cette période',
    'export_disabled_no_data': 'Export PDF désactivé car aucune donnée',
    'no_data_to_export': 'Aucune donnée à exporter',
    'tip': 'Astuce',
    'tip_daily_export': 'Exportez vos dépenses en PDF pour un meilleur suivi de votre budget.',
    'expense_report': 'Rapport des Dépenses',
    'generated_on': 'Généré le',
    'total': 'Total',
    'select_day_view_expenses': 'Sélectionnez un jour pour voir les dépenses',
    'expenses_this_month': 'Dépenses ce mois',
    'articles_this_month': 'Articles ce mois',
    'journal': 'Journal',
    'comparisons': 'Comparaisons',
    'vs_yesterday': 'Vs Hier',
    'vs_average': 'Vs Moyenne',
    'week_total': 'Total Semaine',
    'purchases_today': 'Achats d\'aujourd\'hui',
    'add': 'Ajouter',
    'no_purchases_today': 'Aucun achat aujourd\'hui',
    'add_first_purchase': 'Ajouter un premier achat',
    'view_detailed_stats': 'Voir les statistiques détaillées',
    'analysis_trends': 'Analyses et tendances complètes',
    'month_full': 'Mois complet',
    'general_analysis': 'Analyse générale',
    'export_detailed_report': 'Exporter un rapport détaillé',
    'generate_pdf': 'Générer un PDF complet',
  ...
  mg: {
    ...
    'new_list_placeholder': 'Anaran\'ny lisitra vaovao...',
    'list_title_placeholder': 'Lohateny',
    'reports': 'Tatitra',
    ...
    'delete': 'Fafana',
    'cancel': 'Aoka ihany',
    'rename': 'Ovaina ny anarana',
    'rename_list': 'Ovaina ny anaran\'ny lisitra',
    'list_name': 'Anaran\'ny lisitra',
    'list_renamed': 'Voaova soa aman-tsara ny anarana',
    'rename_error': 'Tsy afaka manova ny anarana',
    ...
    'tip_3': 'Tsindrio ny ... raha hijery safidy (ovaina, fafana).',
    ...
    'total_spent': 'VOLA LANY',
    'progress': 'Fandrosoana',
    'to_buy': 'HOVIDIANA',
    'add_item_placeholder': 'Hanampy entana...',
    'add_product_placeholder': 'Anaran\'ny entana...',
    'ok': 'OK',
    ...
    'period_details': 'Antsipiriany',
    'products_bought': 'Entana novidiana',
    'back': 'Hiverina',
    'products': 'entana',
    'my_list': 'Lisitro',
    'apply': 'Ampiharo',
    ...
    'items': 'entana',
    'no_purchase': 'Tsy nisy fividianana',
    'no_product_bought_period': 'Tsy nisy entana novidiana nandritra ity période ity',
    'export_disabled_no_data': 'Tsy azo atao ny export PDF satria tsy misy donnée',
    'no_data_to_export': 'Tsy misy donnée azo exporté',
    'tip': 'Soso-kevitra',
    'tip_daily_export': 'Exporté PDF ny fandanianao mba hanaraka akaiky ny budget-nao.',
    'expense_report': 'Tatitry ny Fandaniana',
    'generated_on': 'Novoaforonina tamin\'ny',
    'total': 'Fitambarany',
    ...
    'characters': 'litera',
    'journal': 'Boky Fandaniana',
    'comparisons': 'Fampitahana',
    'vs_yesterday': 'Vs Omaly',
    'vs_average': 'Vs Salasalana',
    'week_total': 'Fitambaran\'ny Herinandro',
    'purchases_today': 'Fividianana androany',
    'add': 'Hanampy',
    'no_purchases_today': 'Tsy nisy fividianana androany',
    'add_first_purchase': 'Hanampy fividianana',
    'view_detailed_stats': 'Hijery statistika feno',
    'analysis_trends': 'Famakafakana sy fironana feno',
    'month_full': 'Volana feno',
    'general_analysis': 'Famakafakana ankapobeny',
    'export_detailed_report': 'Haka tatitra feno',
    'generate_pdf': 'Hanamboatra PDF feno',
    'error_loading_stats': 'Tsy nahomby ny fakana statistika',
    ...
    'select_day_view_expenses': 'Misafidiana andro iray hijery fandaniana',
    'expenses_this_month': 'Fandaniana ity volana ity',
    'articles_this_month': 'Entana ity volana ity'
  },
  en: {
    'welcome': 'Welcome',
    ...
    'help': 'Help & Tips',
    'close': 'Close',
    'empty_list': 'No list found',
    'new_list': 'New List',
    'new_list_placeholder': 'List name...',
    ...
    'reminder_set': 'Reminder set in 1 hour.',
    'reminder_title': 'Reminder',
    'reminder_scheduled': 'Reminder scheduled',
    'reminder_notif_text': 'You will be notified on',
    'error': 'Error',
    'info': 'Info',
    'reminder_error': 'Unable to schedule reminder (past date?)',
    'total_spent': 'TOTAL SPENT',
    'progress': 'Progress',
    'to_buy': 'TO BUY',
    'add_item_placeholder': 'Add an item...',
    'add_product_placeholder': 'Product name...',
    'ok': 'OK',
    ...
    'no_product_period': 'No product purchased during this period.',
    ...
    'analyze_error': 'Unable to analyze period',
    'export_error_msg': 'Please run an analysis first before exporting.',
    ...
    'no_product_bought_period': 'No product bought during this period',
    'export_disabled_no_data': 'PDF export disabled - no data available',
    'no_data_to_export': 'No data to export',
    'tip': 'Tip',
    'tip_daily_export': 'Export your expenses as PDF for better budget tracking.',
    ...
    'error_create_suggested': 'Unable to create suggested list',
    'error_enter_name': 'Please enter a name for the shopping list',
    'error_create_list': 'Unable to create shopping list',
    ...
    'error_analyze': 'Unable to analyze',
    'loading': 'Loading...',
    'daily_journal': 'Daily Journal',
    'all_products': 'All products',
    'select_day_view_expenses': 'Select a day to view expenses',
    ...
    'vs_average': 'Vs Moyenne',
    'week_total': 'Total Semaine',
    'purchases_today': 'Listes du jour',
    'add': 'Ajouter',
    'no_purchases_today': 'Aucun achat aujourd\'hui',
    'add_first_purchase': 'Ajouter un premier achat',
    'view_detailed_stats': 'Voir les statistiques détaillées',
    'analysis_trends': 'Analyses complètes et tendances',
    'month_full': 'Mois complet',
    'general_analysis': 'Analyse générale',
    'export_detailed_report': 'Exporter rapport détaillé',
    'generate_pdf': 'Générer PDF complet',
    'error_loading_stats': 'Erreur chargement statistiques'
  }
};
